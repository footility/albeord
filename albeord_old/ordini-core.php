...
function write_table_cat($dbh, $idcat, $nomecat)
{
    ...
    ?>
    <table align='center' width='<?= $w ?>' bgcolor='#ffffff' cellspacing="1" cellpadding="2"
           id="sottocat_<?= $idcat ?>" style="display:none;">
        <tr>
            <td bgcolor='#ffffff' width='<?= $w ?>' height='25' id="cel_scat_<?= $idcat ?>"
                onclick="mostra_from_subcat(<?= $idcat ?>, this)"><input type='button' name='aa' class="invisibile_nc"
                                                                         style="background-color:#cccccc;font-weight:bold;width:120px"
                                                                         value='<?= $nomecat ?>'
                                                                         id='btn_scat_<?= $idcat ?>'></td>
        </tr>
        <?php
...
function write_table_art($dbh, $idcat, $main = 0)
{
    ...
    $fw = $c * $artcol;
    ?>
    <table bgcolor='#000000' align='center' border='0' cellspacing='1' cellpadding='2' id="articoli_<?= $idcat ?>"
           style="display:none;">


        <tr>
            <td align='center' style="background-color:#cccccc;font-weight:bold" bgcolor='#cccccc'
                colspan='<?= $artcol ?>'><?php
                if ($main > 0) {
...
<table width='980' height='400' border='0' cellspacing='0' cellpadding='0' align='center' bgcolor='#000000'>
    <tr>
        <td width='730' bgcolor='#ffffff' valign='top'>
            ...
            <table width='730' border='0' bgcolor='#ffffff' id="concludi" cellspacing='0' cellpadding='3' align='center'
                   height='100%' style="display:none; border:1px solid #000000">
                <tr>
                ...
                <tr>
                    <td valign='top'>
                        <table cellspacing='1' cellpadding='3' class="keypad_class">
                            <tr>
                                <td id="keypad_n_1"><input id="bot1" onmousedown="keypad(this, 1)" type='button'
                                                           value='1' class="invisibile_btn"></td>
                                <td id="keypad_n_2"><input id="bot2" onmousedown="keypad(this, 2)" type='button'
                                                           value='2' class="invisibile_btn"></td>
                                <td id="keypad_n_3"><input id="bot3" onmousedown="keypad(this, 3)" type='button'
                                                           value='3' class="invisibile_btn"></td>
                            </tr>
                            <tr>
                                <td id="keypad_n_4"><input id="bot4" onmousedown="keypad(this, 4)" type='button'
                                                           value='4' class="invisibile_btn"></td>
                                <td id="keypad_n_5"><input id="bot5" onmousedown="keypad(this, 5)" type='button'
                                                           value='5' class="invisibile_btn"></td>
                                <td id="keypad_n_6"><input id="bot6" onmousedown="keypad(this, 6)" type='button'
                                                           value='6' class="invisibile_btn"></td>
                            </tr>
                            <tr>
                                <td id="keypad_n_7"><input id="bot7" onmousedown="keypad(this, 7)" type='button'
                                                           value='7' class="invisibile_btn"></td>
                                <td id="keypad_n_8"><input id="bot8" onmousedown="keypad(this, 8)" type='button'
                                                           value='8' class="invisibile_btn"></td>
                                <td id="keypad_n_9"><input id="bot9" onmousedown="keypad(this, 9)" type='button'
                                                           value='9' class="invisibile_btn"></td>
                            </tr>
                            <tr>
                                <td id="keypad_n_-1"><input id="botDEL" onmousedown="keypad(this, -1)" type='button'
                                                            value='DEL' class="invisibile_btn"></td>
                                <td id="keypad_n_0"><input id="bot0" onmousedown="keypad(this, 0)" type='button'
                                                           value='0' class="invisibile_btn"></td>
                                <td id="keypad_n_-2"><input id="botok" onmousedown="keypad(this, -2)" type='button'
                                                            value='OK' class="invisibile_btn"></td>
                            </tr>
                        </table>
                        <br>
                        <table cellspacing='1' cellpadding='3' class="keypad_class">
                            <tr>
                                <td id="keypad_n_A"><input id="botA" onmousedown="keypad(this, -65)" type='button'
                                                           value='A' class="invisibile_btn"></td>
                                <td id="keypad_n_B"><input id="botB" onmousedown="keypad(this, -66)" type='button'
                                                           value='B' class="invisibile_btn"></td>
                                <td id="keypad_n_C"><input id="botC" onmousedown="keypad(this, -67)" type='button'
                                                           value='C' class="invisibile_btn"></td>
                                <td id="keypad_n_D"><input id="botD" onmousedown="keypad(this, -68)" type='button'
                                                           value='D' class="invisibile_btn"></td>
                                <td id="keypad_n_E"><input id="botE" onmousedown="keypad(this, -69)" type='button'
                                                           value='E' class="invisibile_btn"></td>
                            </tr>
                        </table>
                    </td>
                    <td valign='top'>
                        ...
                        <form name='SENDORD' method='POST' action='ordini-concludi.php'>
                            ...
                            <input type='text' name='camera' value=''
                                   style="font-size:40px;font-weight:bold;width:300px;height:50px; border:1 solid #000000">
                            <br><br><br>
                            <input type='submit' name='camera_submit' onclick="return crea_ordine();"
                                   value='Salva Ordine'
                                   style="background-color:#ffffff;font-size:30px;font-weight:bold;width:300px;height:50px; border:1 solid #000000">
                            <br><br><br>
                            <div align='right' nowrap style="width:300;height:80px">
                                <span style="font-size:20px;" onclick="change_stato('SENDORD')"><img align='middle'
                                                                                                     id="stampatx"
                                                                                                     src='img/si.gif'
                                                                                                     border='0'></span>
            ...
            <table width='730' height='100%' border='0' bgcolor='#000000' id="mcat" class="main_table" cellspacing='1'
                   cellpadding='0' align='center'>
                <tr>
                    <td width='<?= $sottocxatw ?>' rowspan='<?= ceil($nr / $cols) ?>' idcat="mcat" id="cel_mcat_0">
                        <input type='button' name='mostraartlib' value='Articoli liberi' id='btn_mcat_0'
                               class="invisibile" onclick="mostra(0)">
                ...
                <tr>
                    <td align='center' valign='top' width='<?= $sottocxatw ?>' style="background-color:#cccccc">
                    ...
                    <td align='center' valign='top' width='<?= (740 - $sottocxatw) ?>' colspan='<?= $cols ?>'
                        style="padding:2px">
                        <table id="articoli_A" width='625' cellspacing='0' cellpadding='3' border='0'
                        ...
                        <table id="articoli_0" width='625' cellspacing='0' cellpadding='3' border='0'
                               style="border:1px solid #000000;display:none">
                            <form name='articlib_frm'>
                                <tr>
                                    <td colspan='3' style="background-color:#cccccc;" align='center'><b>Articolo
                                            libero</b></td>
                                </tr>
                                <tr>
                                    <td style="font-weight:bold;border-bottom:1px solid #000000" nowrap>Nome</td>
                                    <td style="font-weight:bold;border-bottom:1px solid #000000" nowrap>Prezzo singolo
                                    </td>
                                    <td style="font-weight:bold;border-bottom:1px solid #000000" nowrap>
                                        Quantit&agrave;
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap><input type='text' name='articolo' value='' class="artlibtx"></td>
                                    <td nowrap><input type='text' name='przz' value='' size="8" class="artlibtx"
                                                      style="text-align:right;"> &euro;
                                    </td>
                                    <td nowrap><input type='text' name='quan' value='1' size="3" class="artlibtx"
                                                      style="text-align:center"></td>
                                </tr>
                                <tr>
                                    <td colspan='3' nowrap align='center' height='25' style="background-color:#cccccc">
                                        <input
                                            style="border:1px solid #000000; background-color:#ffffff; height:25px; width:150px"
                                            id="ins_artlib_id" onclick="insert_artlib()" type='button' name='prz'
                                            value='Conferma'>&nbsp;
                                    </td>
                                </tr>
                            </form>
        ...
        <td width='260' bgcolor='#ffffff' valign='top'
            style="background-color:#D0E7F8;padding:2px;border-top:1px solid #000000;border-bottom:1px solid #000000;border-right:1px solid #000000;">
